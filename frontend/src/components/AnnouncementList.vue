        ...
        <v-card-text style="margin-top:-10px;">
            <v-row no-gutters style="margin: 15px 0px -10px -15px;">
                ...
                <v-col style="max-width:150px;">
                    <Admin style="margin-top: 0px; margin-left: 10px;" offline label="CreatedBy" v-model="value.parameters.createdBy" :editMode="editMode" @change="change"/>
                </v-col>
                <v-col style="max-width:140px;">
                    <Date class="attributes-list" label="CreatedAt" v-model="value.parameters.createdAt" :editMode="editMode"/>
                </v-col>
                <v-col style="max-width:140px;">
                    <Date class="attributes-list" label="UpdatedAt" v-model="value.parameters.updatedAt" :editMode="editMode"/>
                </v-col>
                <v-col>
...
<script>
    export default {
        ...
        data: () => ({
            editMode: true,
            value: {
                apiPath: 'announcements/search/announcementList',
                parameters: {}
            },
        }),
        created() {
